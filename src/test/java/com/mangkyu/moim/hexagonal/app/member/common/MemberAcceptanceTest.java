...
class MemberAcceptanceTest {
    ...
    void 중복되는이메일가입실패() {
        ...
        final ExtractableResponse<Response> 중복구성원추가 = 주최자추가("mangkyu@naver.com", "dkssudgktpdy123!@#");
    ...
    void 구성원가입실패_잘못된파라미터(final String 잘못된이메일, final String 잘못된비밀번호) {
        final ExtractableResponse<Response> 구성원추가결과 = 주최자추가(잘못된이메일, 잘못된비밀번호);
    ...
    @Test
    void 구성원가입성공() {
        final ExtractableResponse<Response> 구성원추가결과 = 주최자추가("mangkyu@naver.com", "dkssudgktpdy123!@#");
